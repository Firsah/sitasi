...
<main>
    <div class="container-fluid px-4">
        ...
        <ol class="breadcrumb mb-4">
            ...
            <li class="breadcrumb-item"><a href="{{ route('StaffTrackingController_profile') }}">Profile</a></li>
            <li class="breadcrumb-item">{{ $page2 }}</li>
        </ol>
        <div class="row mt-5">
            <form action="{{ route('StaffTrackingController_prosesEditProfile') }}" method="POST">
                @csrf
                @method('PUT')
                <div class="col-12">
                    <div class="mb-3">
